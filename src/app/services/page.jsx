            ...
            <div className='mx-5 md:mx-20 py-24 '>
                ...
                <div className='my-6 flex md:flex-row flex-col items-center justify-between text-xs md:text-sm sm:text-lg font-medium text-zinc-700'>
                    <ul className=' flex flex-col gap-2 max-w-3xl text-zinc-300 w-fit flex-wrap'>
                        ...
                        <li className='flex h-fit items-center gap-2 w-full'><span className='text-green-700'>●</span> Ponemos en pausa tu cuota en caso de enfermedad o vacaciones</li>
                        ...
                        <li className='flex h-fit items-center gap-2 w-full'><span className='text-green-700'>●</span> Máquinas de sentafilla hack y prensa</li>
