...
const ContactPage = () => {
    ...
    const precios = [
        ...
        },
        {
            ...
            info: 'La duración es de 30 días de corrido desde el día que lo abonas. Por ejemplo, si pagaste un 15 de mes, tu cuota vence el 15 del mes siguiente.',
            price: '$21.400',
            discount: '$20.300',
            infoDiscount: 'Descuento del % pagando en efectivo.'
        },
        {
            ...
            info: 'El plan personalizado, solo es accesible si tenés un acuerdo con alguno de nuestros entrenadores para entrenar exclusivamente con él. Pagas menos en tu cuota mensual del gimnasio pero pagas a tu entrenador el precio que acuerden entre ustedes. Solo es aplicable si el entrenador trabaja para Cúsipde Gym.',
            price: '$17.100',
            discount: '$16.200',
            infoDiscount: 'Descuento del % pagando en efectivo.'
        },
        {
            ...
            info: 'La duración es de tres meses de corrido desde el día que lo abonas. Por ejemplo, si pagaste un 15 marzo, tu cuota vence el 15 de junio del mismo año.',
            price: '$54.100',
            discount: '$51.400',
            infoDiscount: 'Descuento del % pagando en efectivo.'
        },
        {
            ...
            info: 'La duración es de seis meses de corrido desde el día que lo abonas. Por ejemplo, si pagaste un 15 de agosto, tu cuota vence el 15 de febrero del año siguiente.',
            price: '$103.000',
            discount: '$97.600',
            infoDiscount: 'Descuento del % pagando en efectivo.'
        },
        {
            ...
            info: 'La duración es de un año de corrido desde el día que lo abonas. Por ejemplo, si pagaste un 15 de marzo, tu cuota vence el 15 de marzo del año siguiente.',
            price: '$192.000',
            discount: '$182.400',
            infoDiscount: 'Descuento del % pagando en efectivo.'
        }
